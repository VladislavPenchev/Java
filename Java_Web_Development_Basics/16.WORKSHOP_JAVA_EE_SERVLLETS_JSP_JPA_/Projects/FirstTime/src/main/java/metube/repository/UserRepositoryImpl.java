...
public class UserRepositoryImpl implements UserRepository {
    ...
    public long size() {
        ...
        long size = this.entityManager.createQuery("SELECT count(u) FROM User u", long.class)
                .getSingleResult();
    ...
    public User findByUsername(String username) {
        ...
        try{
            user = this.entityManager.createQuery("SELECT u FROM User u WHERE u.username = :username", User.class)
                    .setParameter("username", username)
                    .getSingleResult();
            return user;
        }catch (Exception e){
