...
import com.penchev.exodia.domain.models.binding.LoginBindingModel;
import com.penchev.exodia.domain.models.binding.RegisterBindingModel;
...
public class UserController {
    ...
    public ModelAndView registerConfirm(@ModelAttribute RegisterBindingModel model, ModelAndView modelAndView){
    ...
    @PostMapping("/login")
    public ModelAndView loginConfirm(@ModelAttribute LoginBindingModel model, ModelAndView modelAndView, HttpSession session){
        UserServiceModel userServiceModel = this.modelMapper.map(model, UserServiceModel.class);
        if(userServiceModel == null){
            throw new IllegalArgumentException("User login failed!");
        }

        UserServiceModel userServiceModelfromDb = this.userService.loginUser(userServiceModel);

        if(userServiceModelfromDb != null){
