...
public class CartController extends BaseController {
    ...
    public ModelAndView addToCardConfimr(String id, int quantity, HttpSession session) {
        ...
        List<ShoppingCartItem> cart = this.retriveCart(session);
    ...
    public ModelAndView removeFromCartConfirm(String id, HttpSession session) {
        this.removeItemFromCart(id, this.retriveCart(session));
    ...
    public ModelAndView checkoutConfirm(HttpSession session, Principal principal) {
        var cart = this.retriveCart(session);
    ...
    private List<ShoppingCartItem> retriveCart(HttpSession session) {
    ...
    private OrderServiceModel prepareOrder(List<ShoppingCartItem> cart, String customer) {
        ...
        orderServiceModel.setCutomer(this.userService.findUserByUserName(customer));
