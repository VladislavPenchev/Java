...
import org.softuni.productshop.error.ProductNameAlreadyExistException;
...
public class ProductServiceImpl implements ProductService {
    ...
    public ProductServiceModel createProduct(ProductServiceModel productServiceModel) {
        ...
        Product product = this.productRepository.findByName(productServiceModel.getName())
                .orElse(null);
        if(product != null){
            throw new ProductNameAlreadyExistException("Product already exists");
        }
    ...
    public ProductServiceModel findProductById(String id) {
        return this.productRepository.findById(id)
                .map(p -> this.modelMapper.map(p, ProductServiceModel.class))
                .orElseThrow(() -> new ProductNotForundException("Product with the given id was not found!"));
    }
