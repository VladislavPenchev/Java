...
public class EntityDbContext<T> implements DbContext<T> {
    ...
    private boolean checkIfTableExists() throws SQLException {
        ...
        String query = String.format("SELECT TABLE_NAME FROM information_schema.TABLES WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = '%s';",this.getTableName());
    ...
    private void createTable() throws SQLException {
        ...
        String createStatementBody = String.format(
                "%s, %s",
    ...
    */
    ...
    private List<String> getDatabaseTableColumnsNames() throws SQLException {
        String query = String.format("SELECT COLUMN_NAME FROM information_schema.COLUMNS WHERE TABLE_SCHEMA = DATABASE() AND TABLE_NAME = '%s';",
                this.getTableName());
